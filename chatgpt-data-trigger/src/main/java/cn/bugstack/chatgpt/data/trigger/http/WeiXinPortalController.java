...
public class WeiXinPortalController {
    ...
    public String post(@PathVariable String appid,
        ...
        try {
            ...
            String result = null;
            // 受理消息
            if (entity.getContent().equals("验证码")) {
                result = weiXinBehaviorService.acceptUserBehavior(entity);
                ...
                res.setMsgType("text");
                res.setContent("Ai小组手正在回到你～～");
                /**
                 * bean转成微信的xml消息格式
                 */
                result = XmlUtil.beanToXml(res);
            }
